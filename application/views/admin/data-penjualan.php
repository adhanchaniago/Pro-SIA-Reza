        ...
        <div class="row">
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card text-white bg-primary o-hidden h-100">
              ...
              <a class="card-footer text-white clearfix small z-1" href="<?= base_url('admin/data_penjualan'); ?>">
          ...
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card text-white bg-warning o-hidden h-100">
              ...
              <a class="card-footer text-white clearfix small z-1" href="<?= base_url('admin/data_penjualan/hari'); ?>">
                <span class="float-left">View Details</span>
                <span class="float-right">
                  <i class="fas fa-angle-right"></i>
                </span>
          ...
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card text-white bg-success o-hidden h-100">
              ...
              <a class="card-footer text-white clearfix small z-1" href="<?= base_url('admin/data_penjualan/bulan'); ?>">
                <span class="float-left">View Details</span>
                <span class="float-right">
                  <i class="fas fa-angle-right"></i>
                </span>
          ...
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card text-white bg-danger o-hidden h-100">
              ...
              <a class="card-footer text-white clearfix small z-1" href="<?= base_url('admin/data_penjualan/tahun'); ?>">
                <span class="float-left">View Details</span>
                <span class="float-right">
                  <i class="fas fa-angle-right"></i>
                </span>
        ...
        <?php if($waktu == 'semua') : ?>
        	...
        	<div class="row">
        		<div class="col">
        			...
        			<a href="<?= base_url('laporan/laporan_penjualan'); ?>" target="_blank" class="btn btn-primary mb-3">Cetak</a>
        ...
        <?php if($waktu == 'hari') : ?>
        	...
        	<div class="row">
        		<div class="col">
        			...
        			<a href="<?= base_url('laporan/laporan_penjualan_hari/') . date('d', time()); ?>" target="_blank" class="btn btn-warning mb-3">Cetak</a>
        ...
        <?php if($waktu == "bulan" && $angka == 0) : ?>
	        ...
	        <div class="row">
	        	<div class="col-9">
	        		...
	        		<a href="<?= base_url('laporan/laporan_penjualan_bulan/') . date('m', time()); ?>" target="_blank"  class="btn btn-success mb-3">Cetak</a>
    	...
    	<?php if($waktu == "bulan" && $angka != 0) : ?>
	        ...
	        <div class="row">
	        	<div class="col-9">
	        		...
	        		<a href="<?= base_url('laporan/laporan_penjualan_bulan/') . $angka; ?>" target="_blank"  class="btn btn-success mb-3">Cetak</a>
    	...
    	<?php if($waktu == "tahun" && $angka == 0) : ?>
	        ...
	        <div class="row">
	        	<div class="col-9">
	        		...
	        		<a href="<?= base_url('laporan/laporan_penjualan_tahun/') . date('Y', time()); ?>" target="_blank"  class="btn btn-danger mb-3">Cetak</a>
    	...
    	<?php if($waktu == "tahun" && $angka != 0) : ?>
	        ...
	        <div class="row">
	        	<div class="col-9">
	        		...
	        		<a href="<?= base_url('laporan/laporan_penjualan_tahun/') . $angka; ?>" target="_blank"  class="btn btn-danger mb-3">Cetak</a>
